...
<html lang="en">
    ...
    <body>
        ...
        <div class="body">
            ...
            <p>
                <a href="StudentControllerURL?service=listAll">Show All Student</a>
                <a href="CartController?service=showcart">Show cart</a>
            </p>
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <c:if test="${sessionScope.UserLogin.isIsAdmin()}">
                        ...
                        <td class="table-info"><a href="CartController?service=addtocart&sid=<%= temp.getSID() %>">add</a></td>
                    </c:if>
                </tr>
                <% } %>
            </table>
