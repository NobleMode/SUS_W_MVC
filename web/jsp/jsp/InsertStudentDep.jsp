    ...
    <body>
        ...
        <%
            if(request.getParameter("submit") != null) {
                ...
                StudentDep st = new StudentDep(request.getParameter("id"), fname, lname, request.getParameter("Relation"), request.getParameter("Address"), Integer.parseInt(request.getParameter("Phone")));
                DAOStuDep daoSD = new DAOStuDep();
                daoSD.addStuDep(st);
